...
#  sbc --> configuration --> IP setings --> network --> source_policy_routing --> source_policy_routing_any_policy
#
...
try:
  ...
  module_name = "network"
  obj_type = "source_policy_routing"
  obj_name = "source_policy_routing_88"
